    ...
    return FutureProvider<List<Person>?>(
      ...
      child: FutureProvider<List<Keyword>?>(
        ...
        create: (context) => DatabaseService(uid: 'uid')
            .fetchKeywords(paper.keywords), // Fetch keywords
        initialData: null,
        child: Scaffold(
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Consumer for keywords
                Consumer<List<Keyword>?>(builder: (context, keywords, child) {
                  if (keywords == null) {
                    return Center(child: CircularProgressIndicator());
                  } else if (keywords.isEmpty) {
                    return Center(child: Text('No keywords found.'));
                  } else {
                    return Container(
                      margin: const EdgeInsets.only(bottom: 20.0),
                      child: Row(
